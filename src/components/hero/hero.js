...
import RustyShip from '../../asset/rusty-ship.jpg'
            ...
            <div className="container">
                <div className="row">
                    <div className="col-lg-7">
                        <div className="it_solution_hero_content">
                            <div className="heading_focus_text mb-0 d-inline-flex align-items-center"></div>
                            <h1>
                            Emphasize Global Reach and Quality
                            </h1>
                            <p>
                            Your trusted partner for seamless international trade.
                            </p>
                        </div>
                    </div>
                    <div className="col-lg-5">
                        <ul className="it_solution_hero_images unordered_list">
                            <li>
                                <img src={RustyShip} alt="Techco - IT Solution - Hero" style={{ backgroundSize: 'cover'}} />
                            </li>
                            <li>
